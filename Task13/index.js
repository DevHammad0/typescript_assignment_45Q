...
let favTransport = ["Lamborghini Urus", "Harley Davidson", "Mercedes Benz"];
let statements = ["I would like to test drive", "I really like the ride of", "I would love to buy"];
